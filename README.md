...
* Using the UFO dataset in the form of an array of JavaScript objects, write code that appends a table to web page and then adds new rows of data for each UFO sighting.

  * Make sure all the columns [ `date/time`, `city`, `state`, `country`, `shape`, and `comment` ] are added.
